...
- [进程管理](../system/process.md) - 进程创建和管理
- [字节处理](../system/bytes.md) - 字节操作基础
...
- 学习 [Unix Domain Socket](../system/uds.md) - 更高效的本地 IPC
- 了解 [gRPC 服务](../web/grpc.md) - 跨网络 RPC 通信
- 探索 [进程管理](../system/process.md) - 进程控制基础
...
- 上一步：[Unix Domain Socket](../system/uds.md) - 本地 IPC
- 下一步：[gRPC 服务](../web/grpc.md) - 跨网络 RPC 通信
- 相关：[进程管理](../system/process.md) - 进程控制基础
